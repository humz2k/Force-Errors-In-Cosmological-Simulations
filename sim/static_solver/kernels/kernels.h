...
//extern __global__ void bfloat16_force_solver_shared_mem_cuda(float* eval_pos, float* part_pos, float* mass, float* output, float G, float eps, int n_particles, int n_evals);